...
# Fix for GCC 14/15: Explicitly disable the error for implicit function declarations
HOST_LIBFFI_CONF_ENV += CFLAGS="$(HOST_CFLAGS) -std=gnu17 -Wno-error=implicit-function-declaration"
